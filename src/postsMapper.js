...
function postFromDoc(doc) {
  ...
  return {
    ...
    campaignJobStatus: data.campaignJobStatus || data.campaign_job_status || '',
    ...
    acceptedAt: toIsoOrNull(data.acceptedAt),
    postedAt: toIsoOrNull(data.postedAt),
    publishId: data.publishId || '',
    readyAt: toIsoOrNull(data.readyAt),
    errorMessage: data.errorMessage || '',
    errorEvidence: data.errorEvidence || data.error_evidence || null,
